...
- Broad classification of R syntax:-\vspace{2mm}
    ...
    - **Assignments** - Storing intermediate results of an expression to an object which can be re-used.`<-, =, assign()`
...
- R is case sensitive `name` and `Name` refer to different variables
...
# Interactive R session: 05 - R packages
...
# Interactive R session: 06 - Working directories
...
# Interactive R session: 07 - Getting data into R
...
# Interactive R session: 08 - Data management basics
